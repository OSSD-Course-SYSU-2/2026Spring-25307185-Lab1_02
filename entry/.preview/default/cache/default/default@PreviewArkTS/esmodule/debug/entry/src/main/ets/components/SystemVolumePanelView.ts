...
export class SystemVolumePanel extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/SystemVolumePanelView.ets(42:5)", "entry");
            Column.visibility(this.volumeVisible ? Visibility.Visible : Visibility.Hidden);
            Column.height('50%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create({ alignContent: Alignment.Top });
            Stack.debugLine("entry/src/main/ets/components/SystemVolumePanelView.ets(43:7)", "entry");
            Stack.height(144);
            Stack.width(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Slider.debugLine("entry/src/main/ets/components/SystemVolumePanelView.ets(44:9)", "entry");
