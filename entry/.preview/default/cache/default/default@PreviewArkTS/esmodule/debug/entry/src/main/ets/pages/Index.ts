...
class Index extends ViewPU {
    ...
    NavigationTitle(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Index.ets(32:5)", "entry");
            Column.padding({
                left: 16,
                top: 36
            });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777234, "type": 10003, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/pages/Index.ets(33:7)", "entry");
            Text.fontSize(30);
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/Index.ets(49:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Index.ets(51:7)", "entry");
            Column.width('100%');
            Column.height('100%');
            Column.padding({
                left: 16,
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777254, "type": 10003, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/pages/Index.ets(53:11)", "entry");
            Text.fontSize(15);
            Text.lineHeight(20);
            Text.fontWeight(FontWeight.Bold);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/Index.ets(60:13)", "entry");
                    Text.fontSize(13);
                    Text.opacity(0.6);
                    Text.lineHeight(20);
                }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/Index.ets(78:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel({ "id": 16777263, "type": 10003, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" });
            Button.debugLine("entry/src/main/ets/pages/Index.ets(80:9)", "entry");
            Button.width('100%');
