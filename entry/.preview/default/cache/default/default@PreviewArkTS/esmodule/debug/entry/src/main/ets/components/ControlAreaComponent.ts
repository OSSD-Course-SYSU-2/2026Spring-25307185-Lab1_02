...
export class ControlAreaComponent extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/ControlAreaComponent.ets(69:5)", "entry");
            Column.padding({
                left: 24,
                right: 24
            });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/ControlAreaComponent.ets(70:7)", "entry");
            Column.margin({
                top: 24,
                bottom: 12
            });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Slider.debugLine("entry/src/main/ets/components/ControlAreaComponent.ets(71:9)", "entry");
            Slider.selectedColor('#DBFFFFFF');
            Slider.trackColor({ "id": 16777226, "type": 10001, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/ControlAreaComponent.ets(87:9)", "entry");
            Row.width('100%');
            Row.justifyContent(FlexAlign.SpaceBetween);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.currentTime);
            Text.debugLine("entry/src/main/ets/components/ControlAreaComponent.ets(88:11)", "entry");
            Text.fontColor({ "id": 16777227, "type": 10001, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" });
            Text.fontSize(10);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/ControlAreaComponent.ets(93:11)", "entry");
            Text.fontColor({ "id": 16777227, "type": 10001, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" });
            Text.fontSize(10);
            Text.fontFamily('HarmonyHeiTi');
            Text.lineHeight(14);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/ControlAreaComponent.ets(107:7)", "entry");
            Row.width('100%');
            Row.justifyContent(FlexAlign.SpaceBetween);
            Row.padding({
                left: 36,
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777223, "type": 20000, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/components/ControlAreaComponent.ets(108:9)", "entry");
            __Image__controlImageBuilder();
            Image.width(32);
            Image.onClick(() => {
                this.getUIContext().getPromptAction().openToast({ message: { "id": 16777265, "type": 10003, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" } }).catch(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/components/ControlAreaComponent.ets(116:9)", "entry");
            __Image__controlImageBuilder();
            Image.width(72);
            Image.onClick(() => {
                if (this.isPlay) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777229, "type": 20000, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/components/ControlAreaComponent.ets(126:9)", "entry");
            __Image__controlImageBuilder();
            Image.width(32);
            Image.onClick(() => {
                this.getUIContext().getPromptAction().openToast({ message: { "id": 16777265, "type": 10003, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" } }).catch(() => {
